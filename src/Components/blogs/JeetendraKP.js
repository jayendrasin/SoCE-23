...
const JeetendraKP = () => {
    return (
            ...
            <div className='container-fluid'>
                <div className='row blog-row'>
                    <div className='col-md-4'>
                        <img src='placement-postulates/dp/Jeetendra-Kumar.jpg' className='blog-dp' alt='aryaman'></img>
                    </div>
                    <div className='col-md-8'>
                        <div className='blog-head'>
                            <h2>Jeetendra Kumar Patel</h2>
                            <small>Working in IOCL</small>
                        </div>
                    </div>
                </div>
                <div className='container-fluid'>
        ...
        <img class="blog-image-left" src="placement-postulates/blogs/Jeetendra-Kumar/1.jpg"/>
      ...
      </p><img class="blog-image-right" src="placement-postulates/blogs/Jeetendra-Kumar/2.jpg"/>
      <p>
        ...
        The PSUs also come in Phase 2 (fastest & easiest way to become Sarkari babu 🙂 ). During my placement
      ...
      <p>
        Guys, the most important thing from my side: don’t be shy of our friends and take their help anywhere
        and everywhere possible and vice-versa. They will be the pole star in the dark night of your placement
        drive.
      </p>
      <img class="blog-image-left" src="placement-postulates/blogs/Jeetendra-Kumar/3.jpg"/>
      <p>
        Let me tell you my story….”Hardik Harsh” - I would like to give all the credit for my placement to this
        guy. Not to forget my roomie ‘Danish Ahmad’ - my personal Sandeep Maheshwari. They have helped me cross
        the rough sea.
      </p>
      <p>

        “Hardik Harsh”... Placement ke time daily mere saath jaata mujhe motivate karta rehta .. .jab kisi
        company me nahin hota tha tab bolta tha bhai tension na le…. tera achhi jagah placement hoga... ... usne
        Mock interview and GD ki khoob practice karwai .... even mere IOCL ke time, Placement office me wo
        result ka wait karta rha aur sabse pehle placement ki khabar usne hi bataya tha, “bhai tu placed ho gaya
        hai, aur dekh meri baat sach ho gayi ...” At last friends se help mango aur do jitna ho sake ... contact
