...
import './blogs.css'
const Yashkrit_Gupta = () => {
    return (
        <div className='blog'>
            <div className='container-fluid'>
                <div className='row blog-row'>
                    <div className='col-md-4'>
                        <img src='placement-postulates/dp/Yashkrit-Gupta.jpg' className='blog-dp' alt='yashkrit'></img>
                    </div>
                    <div className='col-md-8'>
                        <div className='blog-head'>
                            <h2>Yashkrit Gupta</h2>
                            <small>Quantitative Analyst at Barclays</small>
                        </div>
                    </div>
                </div>
                <div className='container-fluid'>
      ...
      </p> <img class="blog-image-left" src="placement-postulates/blogs/Yashkrit-Gupta/1.jpg"/>
      ...
      </p><img class="blog-image-right" src="placement-postulates/blogs/Yashkrit-Gupta/2.jpg"/>
      <p>
      ...
      <p><img class="blog-image-left" src="placement-postulates/blogs/Yashkrit-Gupta/3.jpg"/>
