...
const Gaurav_Jiwan = () => {
    return (
            ...
            <div className='container-fluid'>
                <div className='row blog-row'>
                    <div className='col-md-4'>
                        <img src='placement-postulates/dp/Gaurav-Jiwan.jpg' className='blog-dp' alt='aryaman'></img>
                    </div>
      ...
      <p>During the first few years at IIT Kanpur, I did what most do in those years: try out different activities and understand the importance of academics - the hard way. The key takeaway of the exercise was that I became very clear about what I didn't want to do. However, I still had a lot of soul searching to do before I could decide what I wanted to do.

      </p><img class="blog-image-left" src="placement-postulates/blogs/Gaurav-Jiwan/1.jpg"/>
      <p>
      ...
      <p>
        Thus, I started my internship preparation in the 2nd year summers. I learnt DSA from different youtube videos and followed the coding track on interviewbit for practice. For aptitude questions, I referred to prepleaf and for probability/statistics, I went through Brainstellar and Mosteller’s ‘50 Challenging Problems in Probability’, having already studied HSO201 last semester. I felt reasonably confident in coding, but was mostly working on it due to the lack of a better option. 
      </p>
      <p>
      ...
      <p><img class="blog-image-right" src="placement-postulates/blogs/Gaurav-Jiwan/2.jpg"/>
      ...
      </p><img class="blog-image-left" src="placement-postulates/blogs/Gaurav-Jiwan/3.jpg"/>
      <p>
      ...
      <p><img class="blog-image-right" src="placement-postulates/blogs/Gaurav-Jiwan/4.jpg"/>
            ...
            <ol type="a">
              ...
              <li>Sample Resumes
                <ul>
                  ...
                  <li> <a href="https://www.overleaf.com/articles/prabhsimrandeep-singhs-resume/mbkcwgpmwchx">Common Templates</a> </li>
                  
                </ul>
              </li>
            </ol>
          </li>
          <img class="blog-image-left" src="placement-postulates/blogs/Gaurav-Jiwan/5.jpg"/>
          <li>Preparation
            <ol type="a">
              <li>
              ...
              <li>Some useful preparation links:
                <ul>
                  <li> <a href="https://docs.google.com/document/d/1az8Ky3LlqaRcRz0ZOE-tAC0KfCHEkfZk5aRzASZmadw/mobilebasic?fbclid=IwAR1Ua72DTRVi9CnPJIp24d6dX9ZL0TtvMJB5vanudavpxPoXe0cgp6WatjE">A Preparation doc by Prajual Maheshwari</a></li>
      ...
      </p><img class="blog-image-right" src="placement-postulates/blogs/Gaurav-Jiwan/6.jpg"/>
      <p>
